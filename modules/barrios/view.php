...
<section class="content-header">
  <h1>
    <i class="fa fa-user icon-title"></i> Gestión de Barrios

    <a class="btn btn-primary btn-social pull-right" href="?module=form_bar&form=add" title="Agregar" data-toggle="tooltip">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "  <td class='center'>$data[nombre]</td>
                      ...
                      <a data-toggle='tooltip' data-placement='top' title='modificar' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_bar&form=edit&id=$data[idbarrios]'>
