...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-03-2019 a las 20:29:14
...
('123', 'Digitador', 'Digitador', 'digitador@gmail.com', 'digitador', 'd2b87f296cbec3aae6dce5444cae862a', '2019-03-22 17:25:41', 'activo', 2),
('123456789', 'Administrador', 'Admin', 'admin@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3', '2019-03-19 16:43:05', 'activo', 1);
...
CREATE TABLE `usuarios` (
  ...
  `caracterizacion` varchar(50) NOT NULL,
  `telefono` varchar(45) DEFAULT NULL,
  `celular` varchar(45) DEFAULT NULL,
  `lesion_efermedad_deportiva` varchar(100) DEFAULT NULL,
...
--
ALTER TABLE `barrios`
  MODIFY `idbarrios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
